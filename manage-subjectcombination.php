...
<?php if($stts=='0')
{ ?>
<a class="btn text-light bg-success" href="manage-subjectcombination.php?acid=<?php echo htmlentities($result->scid);?>" onclick="confirm('do you really want to ativate this subject');"><i class="fa fa-check" title="Acticvate Record"></i> Activate</a><?php } else {?>

<a class="btn bg-danger text-light" href="manage-subjectcombination.php?did=<?php echo htmlentities($result->scid);?>" onclick="confirm('do you really want to deativate this subject');"><i class="fa fa-times" title="Deactivate Record"></i> Deactivate</a>
<?php }?>
</td>
</tr>
<?php $cnt=$cnt+1;}} ?>
